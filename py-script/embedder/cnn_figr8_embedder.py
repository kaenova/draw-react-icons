...
class CNNFigr8Embedder(core.Embedder):
    repo_id = "kaenova/draw-react-icons"
    filename = "cnn_fig-8_input_1000_20_80_80_1_embed_100epoch.onnx"

    input_shape_size = (1, 80, 80, 1)  # Batch size, h, w, chan
    input_name = "x"
    output_name = "leaky_re_lu_3"
